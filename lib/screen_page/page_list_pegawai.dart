...
import 'package:simulasi_01/screen_page/page_bottom_navigation.dart';
import 'package:simulasi_01/screen_page/page_edit_pegawai.dart';
import 'package:simulasi_01/screen_page/page_login_api.dart';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://192.168.89.194/edukasi_server/getPegawai.php"));
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://192.168.89.194/edukasi_server/deletePegawai.php'),
